layui.extend({
    ...
    var tableIns = table.render({
        ...
        cols : [[
            ...
            {field: 'name', title: '班级名', Width:100, align:"center"},
            {field: 'xname', title: '教员',  align:'center'},
	    ...
	    switch(obj.event){
	      ...
	      case 'deddddlUser':	//ɾ���û�
	    	  if(data.length == 0 || data.length > 1){
					...
					layer.confirm('确定删除班级吗', {icon: 3, title:'提示ʾ'}, function(index){
    ...
    function upUser(userid){
    	...
    	layui.layer.open({
    		title : "修改班级",
    		type : 2,
    		content : "/Student/jsp/banji/banjixiugai.jsp",
    		area:['400px','540px'],
    		success:function(layero, index){
    			$.ajax({
    				url:"/Student/news?action=banjixiugaichaxun",
    				type:"post",
    				data:{"userid":userid},
    ...
    function delUser(userid){
    	$.ajax({
    		url:"/Student/news?action=banjidel",
    		data:{"userid":userid},
    		type:"post",
    		success:function(data){
    			if(data == 1){
...
/*    //�����ɫ
    ...
    function addUser(){
    	layui.layer.open({
    		title : "新增班级",
    		type : 2,
    		content : "/Student/jsp/banji/banjiadd.jsp",
    		area:['400px','490px'],
    	})
    }
