	...
	// 签到管理
		...
		// 班级管理
				...
				// 班级管理
						...
						public String zop(HttpServletRequest request, HttpServletResponse response)throws ServletException, IOException {
							String ids = request.getParameter("id");
							int uid=Integer.parseInt(request.getParameter("uid"));
							System.out.println(uid);
							int id = Integer.parseInt(ids);
						...
						public void zops(HttpServletRequest request, HttpServletResponse response)
								throws ServletException, IOException {  
							request.getParameter("UTF-8");
							String ids=request.getParameter("id");
							System.out.println(ids);
							...
							List<Student> list = new ServiceImpl().seleteqds();
							page<Student> page = new page<Student>();
							page.setCode(0);
							page.setCount(list.size());
							page.setMsg("");
