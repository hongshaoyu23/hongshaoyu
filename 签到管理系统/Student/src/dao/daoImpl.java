...
public class daoImpl extends Basedao implements dao {
	...
	public int StudentAdd(Student student) {
		String sql="INSERT INTO student (xname,loginname,PASSWORD,classid) VALUES(?,?,?,?,1) ";
	...
	@Override
	public List<Student> seleteqd() {
	
		// TODO Auto-generated method stub

		List<Student> list = new ArrayList<Student>();
		ResultSet rs = null;
		String sql="SELECT s.id,xname,t.data,t.deletes FROM student AS s,TIME AS t WHERE s.`id`=t.id ORDER BY DATA DESC  ";
	...
	@Override
	public int qdAdd(Student student) {
		// TODO Auto-generated method stub
		return 0;
	}
	...
	@Override
	public int qxUpdate(Student student) {
		// TODO Auto-generated method stub
		return 0;
	}
	...
	@Override
	public Student qxSelectId(int id) {
		// TODO Auto-generated method stub
		return null;
	}
